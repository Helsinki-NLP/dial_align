...
$M2MPATH/m2m-aligner --inFormat news --sepChar "#" --nullChar "@" --delX --delY --maxX 1 --maxY 1 --errorInFile -i $PROJECT/$FID.input --init $PROJECT/init.model -o $PROJECT/$FID.aligned --alignerOut $PROJECT/$FID.model
